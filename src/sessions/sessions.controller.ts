...
export class SessionsController {
  ...
  @ApiResponse({ status: 400, description: 'Validation error or invalid datetime format' })
  @ApiResponse({ status: 422, description: 'Session end time before start time, or session is too far in the past' })
